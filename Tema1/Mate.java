public class Mate{
	...
	// FUNCION PERFECTO
	public static bool perfecto(int numero){
	...
	public static bool amigos(int num_1, int num_2){
	...
	public static bool primos(int n1, int n2){
		int i,mayor,menor;
		if (n1 > n2){
	   		mayor = n1;
	      		menor = n2;
	...
	public static int euler(int n){
		...
		// cuantos hay menor que este numero que sean primos con él
	}
